classdef brain_observatory_cache < handle
    ...
    methods
        ...
        function get_number_of_expriment_containers (boc)
            size(boc.container_table,1)
        end
        
        function get_number_of_valid_experiment_containers (boc)
            size(boc.container_table(boc.container_table.failed==0,:),1)
        end
        
        function get_all_imaing_depths (boc)
            categories(categorical(cellstr(num2str((boc.container_table.imaging_depth)))))
        end
        ...
        function get_all_cre_lines (boc)
            categories(categorical(boc.container_table.cre_lines))
        end
