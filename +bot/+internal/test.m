...
classdef test < matlab.unittest.TestCase
   ...
   methods (Test)
      ...
      function testObtainSessionObject(testCase)
         ...
         % - Create some bot.items.ophyssession objects
         bot.items.ophyssession(vIDs(1));
         bot.session(vIDs(1:2));
         bot.items.ophyssession(bosf.valid_session_table(1, :));
      end
      
      function testCacheSessionObject(testCase)
         %% Test obtaining an OPhys session object data from the cache
         % - Create a bot.items.ophyssession object
         s = bot.items.ophyssession(704298735);
      ...
      function testSessionDataAccess(testCase)
         %% Test data access methods of the bot.items.ophyssession class for OPhys data
         % - Create a bot.items.ophyssession object
         s = bot.items.ophyssession(496934409);
      ...
      function testStimulusExtraction(testCase)
         ...
         % - Create a bot.items.ophyssession object
         s = bot.items.ophyssession(528402271);
         ...
         s = bot.items.ophyssession(566752133);
