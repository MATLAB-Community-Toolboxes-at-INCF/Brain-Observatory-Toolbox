...
directory_name = [stimuli,'_', session_id];
...
for i = 1:size(dfOverF_data,2)
    ...
    raster_site_info = generate_raster_site_info(i, container_id, para_raster,session_id,session_type);
...
function raster_site_info = generate_raster_site_info(i, container_id, para_raster,session_id,session_type)
